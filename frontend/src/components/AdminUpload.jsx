...
function AdminUpload() {
  ...
  return (
    <div className="max-w-xl mx-auto p-4 md:p-6 space-y-4 select-none">
      <NavLink to="/admin" className="btn btn-xs btn-ghost gap-1 text-slate-400 hover:text-slate-100">
